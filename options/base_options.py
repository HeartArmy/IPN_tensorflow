...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # paras1
        parser.add_argument('--dataroot', default='/scratch/maj596/IPN-OCTA-Segmentation/Data', help='path to data')
        ...
        # paras2
        parser.add_argument('--saveroot', default='/scratch/maj596/IPN-OCTA-Segmentation/IPN1_tensorflow/logs', help='path to save results')
